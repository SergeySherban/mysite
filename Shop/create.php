    ...
    <div class="container p-3">
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="name" placeholder="Title" class="form-control" id="exampleFormControlInput1" style="width: 300px;">
            </div>
            <div class="form-group">
                <label for="exampleFormControlInput1">Year</label>
                <input type="text" name="year" placeholder="Year" class="form-control" id="exampleFormControlInput1" style="width: 300px;">
            </div>
            <div class="form-group">
                <label for="exampleFormControlInput1">Price</label> <br>
                <input type="text" name="price" placeholder="Pricer" class="form-control" id="exampleFormControlInput1" style="width: 300px;">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="file" name="preview" class="form-control-file" id="exampleFormControlFile1">
            </div>
            <div class="form-group">
